          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Join thousands of travelers who have discovered the joy of exploring the world together.
                Share your stories, connect with fellow adventurers, and inspire others.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
              {stats.map((stat) => (
                <Card key={stat.label} className="p-6 text-center border-border hover:border-primary transition-colors">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {featuredTravelers.map((traveler) => (
                <Card key={traveler.id} className="p-6 border-border hover:border-primary transition-all hover:shadow-lg">
        ...
        <section className="py-16 bg-gradient-to-b from-background to-primary/5">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Start your journey with us and become part of a community that loves to explore, share, and create memories together.
            </p>
